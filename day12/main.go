...
func main() {
	...
	slice1 = slice1[1:]
	printInfo("after reslice slice1 at the start", &baseArr, &slice1, &slice2)

	slice1 = slice1[:1]
	printInfo("after reslice slice1 at the end", &baseArr, &slice1, &slice2)

	slice1 = append(slice1, 128)
	printInfo("after append", &baseArr, &slice1, &slice2)

	slice1 = slice1[:len(slice1)+1]
	printInfo("after reslick", &baseArr, &slice1, &slice2)
